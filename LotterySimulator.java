...
public class LotterySimulator extends GM{
	...
	public static void main(String args[]){
		int[] data = {0,0,0,0,0};
		//Zeroeth is a 1 or 0 determining whether the method was called successfully or not
		...
		while((timecount<2000)&&(wins<10)){
			...
			if (timecount==newtimecount){
				...
				while(dea.countCars()==0){
					...
					info = info+ "\n"+veh.getVehicleType()+" is the type. "+veh.getPrice()+" is the price. "+veh.getCurrentID()+" is the ID";
					info = info+ "\n"+"The dealer is "+dnm;
