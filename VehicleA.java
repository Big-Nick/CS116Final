...
//copyright IIT-George Koutsogiannakis
...
public class VehicleA implements Serializable
{
	...
	public String toString()
	{
		...
		String str="The vehicle ID is:"+" "+currentID+" "+"The maximum velocity is:"+" "+velocity+"m/sec"+" "+"The price is:"+" "+price+""+"The type is:"+" "+vt+" "+"The vehicle belongs now to person:"+" "+p.getLastName()+"The time of award was:"+" "+timeawarded;
		return str;
	}
